...
from slowfast.utils import is_master_proc, get_world_size, is_root_proc
...
def setup_logging(output_dir=None):
    ...
    if output_dir is not None and is_master_proc(get_world_size()):
...
def log_json_stats(stats, output_dir=None):
    ...
    if is_root_proc() and output_dir:
